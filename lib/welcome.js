...
weButt = { contentText: `${textwel3}`, footerText: `Created By 𝐹𝑎𝑗𝑎𝑟 𝐴𝑙𝑓𝑎𝑟𝑖𝑧𝑖`, buttons: weBut, headerType: 6, locationMessage: Karina2.message.locationMessage}
...
wButt = { contentText: `${teks}`, footerText: `Created By 𝐹𝑎𝑗𝑎𝑟 𝐴𝑙𝑓𝑎𝑟𝑖𝑧𝑖`, buttons: wBut, headerType: 6, locationMessage: Karina4.message.locationMessage}
if(settings.picdetec == true ){
...
wB = [{buttonId:`welkome`,buttonText:{displayText:'Sayonara'},type:1}]
wBu = { contentText: `${textleft3}`, footerText: `Created By 𝐹𝑎𝑗𝑎𝑟 𝐴𝑙𝑓𝑎𝑟𝑖𝑧𝑖`, buttons: wB, headerType: 6, locationMessage: Karina6.message.locationMessage}
...
wBo = [{buttonId:`byegan`,buttonText:{displayText:'Sayonara'},type:1}]
wBot = { contentText: `${teks2}`, footerText: `Created By 𝐹𝑎𝑗𝑎𝑟 𝐴𝑙𝑓𝑎𝑟𝑖𝑧𝑖`, buttons: wBo, headerType: 6, locationMessage: Karina8.message.locationMessage}
if(settings.picdetec == true ){
...
promoteButt = { contentText: `${teks}`, footerText: `Created By 𝐹𝑎𝑗𝑎𝑟 𝐴𝑙𝑓𝑎𝑟𝑖𝑧𝑖`, buttons: promotebut, headerType: 6, locationMessage: Karina10.message.locationMessage}
...
demoteButt = { contentText: `${teks}`, footerText: `Created By 𝐹𝑎𝑗𝑎𝑟 𝐴𝑙𝑓𝑎𝑟𝑖𝑧𝑖`, buttons: demotebut, headerType: 6, locationMessage: Karina12.message.locationMessage}
